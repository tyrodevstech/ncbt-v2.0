    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_status', models.CharField(choices=[('', 'Select Status'), ('Running', 'Running '), ('Discontinue', 'Select Status')], max_length=120, null=True)),
                ('religion', models.CharField(max_length=120, null=True)),
                ('nationality', models.CharField(max_length=120, null=True)),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='std_portal.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(max_length=120, null=True)),
                ('academic_status', models.CharField(choices=[('', 'Select Status'), ('running', 'Running '), ('discontinue', 'Select Status')], max_length=120, null=True)),
                ('group', models.CharField(choices=[('', 'Select Group'), ('science', 'Science'), ('commerce', 'Business Studies / Commerce'), ('arts', 'Humanities / Arts')], max_length=120, null=True)),
                ('religion', models.CharField(max_length=120, null=True)),
                ('nationality', models.CharField(max_length=120, null=True)),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='std_portal.course')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='std_portal.studentregistrationuni')),
            ],
        ),
        migrations.CreateModel(
            name='Financial',
        ...
        migrations.AddField(
            model_name='course',
            name='department',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='std_portal.department'),
        ),
    ]
